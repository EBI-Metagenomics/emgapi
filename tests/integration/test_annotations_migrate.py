...
class TestAnnotationsMigration(object):

    def test_migration(self, client, run, mongodb):
        ...
        call_command('import_summary', 'ABC01234',
                     os.path.dirname(os.path.abspath(__file__)),
                     suffix='.ipr')
        call_command('migrate_annotations', 'ABC01234')

        # drop old collections
        mongodb['testdb'].drop_collection("analysis_job_go_term")
        mongodb['testdb'].drop_collection("analysis_job_interpro_identifier")
